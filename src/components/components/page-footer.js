    ...
    <footer className="page-footer">
      <div className="page-footer-grid">
        <div className="page-footer-links">
          ...
          <a href="https://www.linkedin.com/in/jonathan-gartland-01b7ba16" className="footer-link">
            <img src="LI-In-Bug.png" alt="Gmail" className="footer-link-image"/>
          </a>

          <a href="https://github.com/jonathan-gartland" className="footer-link">
            <img src="/Github_Logo_White.png" alt="Gmail" className="footer-link-image" />
          </a>

          <a href="https://www.buymeacoffee.com/jonathan.gartland" target="_blank"><img
